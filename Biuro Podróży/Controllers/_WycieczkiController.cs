...
{
    [AllowAnonymous]
    public class _WycieczkiController : Controller
    {
        private readonly BiuroContext _context;

        public _WycieczkiController(BiuroContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                var biuroContext = _context.Wycieczka_Klient.Include(w => w.Wycieczka);
